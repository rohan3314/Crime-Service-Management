<%-- 
    ...
    Created on : 16 Jul, 2023, 8:34:12 PM
    Author     : HP
--%>
    ...
    <div id="signup-form">               
        <div id="signup-inner">        
        	<div class="clearfix" id="header">        	
        		<img id="signup-icon" src="./images/img13.jpg" alt="" />
...
<p>
                ...
                <table>
                    <tr>
                     ...
                     <input type="submit" onClick="parent.location='userdetails.jsp'" value="Register" >
                </div>
    </div>
        <div align="center">
                        <a href="userdetails.jsp"><font size="5" face="Comic Sans Ms">Exit</font></a>
                    </div>
        </center>
    </body>
</html>
