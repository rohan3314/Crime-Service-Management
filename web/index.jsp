  ...
  <!-- Facebook and Twitter integration -->
				...
				<div class="row">
					...
					<div class="col-md-10 text-right menu-1">
						<ul>
							...
							<li><a href="https://hyderabadpolice.gov.in/">About</a></li>
							<li><a href="https://hyderabadpolice.gov.in/Important_Contacts.html">Contact</a></li>
	...
	<aside id="colorlib-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(images/ram.jpg);">
...
<!--									<p><a class="btn btn-primary btn-lg" href="#">Make An Appointment</a></p>-->
		   	...
		   	<li style="background-image: url(images/ram1.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
